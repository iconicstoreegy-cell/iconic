      ...
      <div className="container-custom relative pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            ...
            <p className="font-arabic text-lg text-neutral-500 mb-6">تريفيرو</p>
            <p className="text-sm leading-relaxed text-neutral-400 max-w-sm mb-8">
              {t('footer.tagline')}
            </p>
            <div className="flex gap-4">
              {[FiInstagram, FiTwitter, FiFacebook].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-primary-900 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-accent-500 transition-all duration-300 transform hover:-translate-y-1">
                  <Icon size={18} />
                </a>
              ))}
            </div>
          ...
          <div className="md:col-span-4 lg:col-span-3">
            ...
            <ul className="space-y-4 text-sm font-medium text-neutral-400">
              <li>
                <a href="mailto:treverostore@gmail.com" className="hover:text-white transition-colors flex items-center gap-2 group">
                  treverostore@gmail.com
        ...
        <div className="border-t border-primary-900 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs font-medium text-neutral-500">
            © {new Date().getFullYear()} TreVero. {t('footer.rights')}
          </p>
